...
class CreateFragment : Fragment() {
    ...
    // benötigt kein Observer, da nur Data erstellt wird, nicht beobachtet
    ...
    private lateinit var categoryGroup: SegmentedButtonGroup
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        requireActivity().activity_bottom_bar_title.text = getString(R.string.toolbar_title_create)
        setupDefaultValues()
        setupListeners()
        loadLayoutAnimation()
    }
    ...
    private fun setupDefaultValues() {
        ...
        fragment_create_trick__direction_in_regular.isSelected = true
        directionOut = DirectionOut.TO_REGULAR
        fragment_create_trick__direction_out_to_regular.isSelected = true
        category = Category.GRIND
        fragment_create_trick__category_grinds.isSelected = true
        difficulty = Difficulty.SAVE
        fragment_create_trick__difficulty_save.isSelected = true
...
//        }
        ...
        categoryGroup.setOnClickedButtonListener(object: SegmentedButtonGroup.OnClickedButtonListener {
            override fun onClickedButton(position: Int) {
                categoryGroup.setPosition(position, false)
                when(position){
                    0 -> category = Category.GRIND
                    1 -> category = Category.SLIDE
                    2 -> category = Category.OTHER
                }
            }
        })
