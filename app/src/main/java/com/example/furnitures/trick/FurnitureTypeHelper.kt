...
import com.example.furnitures.trick.FurnitureType.*
...
object FurnitureTypeHelper {
    ...
    fun getDrawable(furnitureType: FurnitureType): Int {
        return when (furnitureType) {
            ...
            UNDEFINED -> throw IllegalStateException("\"Could not find Drawable for furniteType \" + furnitureType")
        }
    }
    ...
    fun getString(furnitureType: FurnitureType): Int? {
        return when (furnitureType) {
            ...
            UNDEFINED -> throw IllegalStateException("Could not find String for furniteType $furnitureType")
        }
    }
}
